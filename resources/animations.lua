...
return {
  patato = {
    ...
    standAttackingFlySwat = {{{9, 0.03}, {10, 0.1, {90, -90, 180, 80}},
                            {9, 0.05}}, false},
    crouchAttackingFlySwat = {{{11, 0.03}, {12, 0.1, {100, -16, 180, 80}},
                            {11, 0.05}}, false},
    ...
    climbAttackingFlySwat = {{{19, 0.03}, {20, 0.1, {110, -120, 180, 80}},
                            {19, 0.05}}, false},
